...
import com.ms.jpa.advance.specification.exception.SpecificationException;
...
public class WhereSpecification implements Specification<Object> {
    ...
    private boolean assertCollection(Object value) {
        ...
        throw new IllegalStateException("After operator " + Filter.IN + " should be a list, not '" + value + "'");
    }
